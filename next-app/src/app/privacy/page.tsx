  ...
  return (
    <main className="min-h-screen bg-white text-gray-900">
      <div className="mx-auto max-w-4xl px-6 py-12">
        ...
        <p className="mt-3 text-sm text-gray-600">Stand: 2026-03-27</p>
        ...
        <section className="mt-8 space-y-4 text-sm leading-6 text-gray-700">
          ...
          <h2 className="text-xl font-semibold text-gray-900">1. Verarbeitungszwecke</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-gray-900">2. Kategorien von Daten</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-gray-900">4. Speicherung und Loeschung</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-gray-900">5. Betroffenenrechte</h2>
          <p>
          ...
          <h2 className="text-xl font-semibold text-gray-900">6. Sicherheit</h2>
          <p>
