        ...
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
            <IOSCard className="p-6">
              ...
              {!todayMenu ? (
                <div className="text-gray-500 text-sm">No menu for today</div>
              ) : (
                <>
                  <p className="font-medium text-lg mb-2">{todayMenu.meal_name}</p>
                  <p className="text-gray-600 text-sm mb-3">{todayMenu.description}</p>
                  {todayMenu.allergens && todayMenu.allergens.length > 0 && (
                    <div className="text-xs text-orange-600">Allergens: {todayMenu.allergens.join(', ')}</div>
                  )}
                </>
              )}
            </IOSCard>
            ...
            <IOSCard className="p-6">
              ...
              <div className="space-y-2">
                <Link href="/kitchen/menus" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-md transition-colors">
                  🍽️ Manage Menus
                </Link>
                <Link href="/kitchen/orders" className="block px-4 py-2 text-gray-700 hover:bg-gray-100 rounded-md transition-colors">
                  🛒 View Orders
                </Link>
              </div>
            </IOSCard>
