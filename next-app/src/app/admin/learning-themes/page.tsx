    ...
    <div className="max-w-7xl mx-auto pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
        <div>
          ...
          <p className="text-lg text-slate-500 font-medium max-w-2xl">
            Plan and document pedagogical focuses, learning objectives, and group projects.
          </p>
        </div>
      ...
      {learningThemes.length === 0 && !loading && (
        <IOSCard className="p-24 text-center border-dashed border-2 border-slate-200 bg-transparent shadow-none">
            ...
            <p className="text-slate-500 font-bold text-xl">No learning themes found</p>
            <p className="text-slate-400 mt-2 font-medium">Start documenting your curriculum by creating a theme.</p>
        </IOSCard>
      )}
    </div>
  )
