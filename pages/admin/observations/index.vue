<template>
  <div>
    ...
    <div v-else-if="error" class="mb-6">
      <ErrorAlert :message="error.message || 'Error loading observations'" />
    </div>
          ...
          <div class="flex items-start justify-between">
            <div class="flex-1">
              ...
              <div v-if="observation.photos && observation.photos.length > 0" class="mt-2">
                <span class="text-xs text-gray-500">📷 {{ observation.photos.length }} photos</span>
              </div>
            </div>
            <div class="flex items-center gap-2">
              <NuxtLink
                :to="`/admin/observations/${observation.id}`"
              ...
              <NuxtLink
                :to="`/admin/observations/${observation.id}?edit=true`"
