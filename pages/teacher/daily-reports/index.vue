  ...
  <div>
    <div class="flex justify-between items-center mb-6">
      <div>
        ...
        <p class="text-sm text-gray-600 mt-1">Erstellen Sie tägliche Berichte für Eltern</p>
      </div>
      <NuxtLink
        to="/teacher/daily-reports/new"
          ...
          <div class="flex items-start justify-between">
            <div class="flex-1">
              ...
              <div v-if="report.activities && report.activities.length > 0" class="mb-2">
                <p class="text-sm font-medium text-gray-700">Aktivitäten:</p>
              ...
              <div v-if="report.photos && report.photos.length > 0" class="mt-2">
                <span class="text-xs text-gray-500">📷 {{ report.photos.length }} Fotos</span>
              </div>
            </div>
            <div class="flex items-center gap-2">
              <NuxtLink
                :to="`/teacher/daily-reports/${report.id}`"
              ...
              <NuxtLink
                :to="`/teacher/daily-reports/${report.id}?edit=true`"
