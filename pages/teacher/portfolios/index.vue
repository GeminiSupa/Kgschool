  ...
  <div>
    <div class="flex justify-between items-center mb-6">
      <div>
        ...
        <p class="text-sm text-gray-600 mt-1">Verwalten Sie Portfolios der Kinder</p>
      </div>
      <NuxtLink
    ...
    <div v-else class="bg-white rounded-lg shadow overflow-hidden">
      ...
      <div v-else class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 p-6">
        ...
        >
          <div v-if="portfolio.attachments && portfolio.attachments.length > 0" class="mb-3 aspect-video bg-gray-100 rounded overflow-hidden">
            <img
          ...
          <div class="flex items-center gap-2 mt-3">
            ...
            <NuxtLink
              :to="`/teacher/portfolios/${portfolio.id}?edit=true`"
