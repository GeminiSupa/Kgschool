    ...
    <div className="max-w-7xl mx-auto pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Verwalten Sie Gehälter, Überstunden und Auszahlungen.</p>
        </div>
      ...
      {error ? (
        ...
        <IOSCard className="p-20 text-center bg-gray-50/30 border-black/5">
          ...
          <p className="text-gray-400 font-bold max-w-xs mx-auto">Keine Abrechnungen für diesen Zeitraum gefunden.</p>
        </IOSCard>
      ) : (
                    ...
                    <div className="p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                                <h3 className="text-lg font-black text-gray-900">{getStaffName(entry.staff_id)}</h3>
