...
const ROUTE = 'admin.lunch.billing.timetable.new'
...
export default function AdminLunchBillingTimetableNewPage() {
  const { t } = useI18n()
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await supabase.from('billing_timetable').insert([payload]).select().single()
