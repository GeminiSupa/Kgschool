    ...
    <div className="max-w-7xl mx-auto pb-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-10">
        ...
        <Link href="/admin/lunch/menus/new">
          <IOSButton className="px-6 py-2.5 text-sm font-black uppercase tracking-widest">
            ➕ Menü hinzufügen
          </IOSButton>
        </Link>
      </div>
      ...
      <div className="mb-10 flex gap-4">
            <div className="flex flex-col gap-1">
                ...
                <input 
                    ...
                    className="px-5 py-2.5 bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 rounded-2xl text-[11px] font-black uppercase tracking-widest shadow-sm focus:ring-2 focus:ring-(--aura-primary)/25 outline-none transition-all text-slate-900 dark:text-slate-50"
                />
            </div>
      </div>
                ...
                <IOSCard key={menu.id} className="p-0 overflow-hidden border-black/5 group hover:shadow-2xl transition-all duration-500">
                    <div className="relative h-48 bg-gray-100 overflow-hidden">
                        {menu.photo_url ? (
                            ...
                            <div className="w-full h-full flex items-center justify-center text-4xl opacity-20 bg-linear-to-br from-gray-50 to-gray-200">🥘</div>
                        )}
                    ...
                    <div className="p-8">
                        <h3 className="text-xl font-black text-slate-900 dark:text-slate-50 mb-3 group-hover:text-aura-primary transition-colors">{menu.meal_name}</h3>
                        ...
                        <div className="flex gap-2">
                             ...
                             <Link href={`/admin/lunch/menus/${menu.id}/edit`}>
                                <IOSButton variant="secondary" className="p-2.5 bg-white dark:bg-white/5 border border-black/5 dark:border-white/10 text-aura-primary hover:border-(--aura-primary)/40">✏️</IOSButton>
                             </Link>
                        </div>
                    </div>
                </IOSCard>
