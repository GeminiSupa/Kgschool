  ...
  return (
    <div className="max-w-4xl mx-auto pb-12">
      <div className="mb-10 text-center">
        ...
        <p className="text-sm text-gray-500 mt-1">Überblick über Ihre monatlichen Gehaltsabrechnungen.</p>
      </div>

      {payroll.length === 0 ? (
        <IOSCard className="p-20 text-center bg-gray-50/30 border-black/5">
          <div className="text-6xl opacity-10 mb-6">💼</div>
          <p className="text-gray-400 font-bold max-w-xs mx-auto">Noch keine Abrechnungen in diesem System vorhanden.</p>
        </IOSCard>
      ) : (
                    ...
                    <div className="p-6 md:p-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
                        <div className="flex-1">
                            <div className="flex items-center gap-3 mb-2">
                                <h3 className="text-lg font-black text-gray-900">{new Date(entry.year, entry.month - 1).toLocaleString('de-DE', { month: 'long', year: 'numeric' })}</h3>
