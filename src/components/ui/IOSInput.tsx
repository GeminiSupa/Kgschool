    ...
    <div className={cn('w-full space-y-2', className)}>
      ...
      <div className="relative">
        <input
          id={id}
          className={cn(
            'w-full px-4 py-3 bg-background border-2 border-border rounded-2xl text-foreground placeholder:text-muted transition-all duration-300 outline-none focus:ring-2 focus:ring-(--aura-primary)/25 focus:border-aura-primary disabled:opacity-50 disabled:cursor-not-allowed',
